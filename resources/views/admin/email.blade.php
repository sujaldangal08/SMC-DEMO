                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="padding-top: 20px; padding-bottom: 20px; padding-right: 0px;"
                                                        align="right" valign="middle" class="webview"> <a
                                                            href="https://jobscout.tech"
                                                            ...
                                                            target="_blank" class="text hideOnMobile">Visit JobScout
                                                            →</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="background-color:#2ab463;font-size:1px;line-height:3px"
                                                ...
                                                <tr>
                                                    <td style="padding-top: 30px; padding-bottom: 30px;" align="center"
                                                        ...
                                                        <a href="#" style="text-decoration:none" target="_blank">
                                                            <img alt="" border="0"
                                                                src="https://i.ibb.co/CV1ZDq9/jobscout.png"
                                                                ...
                                                                <tr>
                                                                    <td style="padding-bottom: 20px;" align="center"
                                                                        ...
                                                                        <p class="text"
                                                                            ...
                                                                            We understand that forgetting your password
                                                                            can be frustrating, but don't worry - we're
                                                                            here to help!

                                                                            To get you back into your account on
                                                                            JobScout, please reset your password using
                                                                            the link and button below:</p>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                                ...
                                                                <tr>
                                                                    <td style="padding-top:20px;padding-bottom:20px"
                                                                        ...
                                                                        <table border="0" cellpadding="0"
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="background-color: #2ab463; padding: 12px 35px; border-radius: 50px;"
                                                                                        align="center"
                                                                                        class="ctaButton"> <a
                                                                                            href="{!! $body !!}"
                                                ...
                                                <tr>
                                                    <td style="padding: 10px 10px 5px;" align="center" valign="top"
                                                        ...
                                                        <p class="text"
                                                            ...
                                                            ©&nbsp;JobScout Inc. | Buddha Marga | Kathmandu, 44600
                                                            Nepal.</p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="padding: 0px 10px 20px;" align="center" valign="top"
                                                        ...
                                                        <p class="text"
                                                            ...
                                                            <a href="#"
                                                                ...
                                                                target="_blank">Account</a>&nbsp;|&nbsp; <a
                                                                href="#"
                                                                style="color:#bbb;text-decoration:underline"
                                                                target="_blank">Browse Jobs</a>&nbsp;|&nbsp; <a
                                                                href="#"
                                                                style="color:#bbb;text-decoration:underline"
                                                    ...
                                                    <td style="padding: 0px 10px 10px;" align="center" valign="top"
                                                        ...
                                                        <p class="text"
                                                            ...
                                                            If you have any quetions please contact us <a
                                                                href="#"
                                                                style="color:#bbb;text-decoration:underline"
                                                                target="_blank">support@jobscout.tech</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="font-size:1px;line-height:1px" height="30">&nbsp;
